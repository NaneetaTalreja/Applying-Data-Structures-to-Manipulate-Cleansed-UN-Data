...
public class Driver {
	public static void main(String[] args) {
		String csvFile = "unspsc codes_3-1.csv";
		String line = "";
        ...
        Stack<Commodity> stackCommmodities = new Stack<Commodity>();
        Queue<Commodity> queueCommmodities = new LinkedList<Commodity>();
       ...
       for(int i = 0; i < SIZEOFINPUT; i++) {
        ...
        System.out.println(stackCommmodities.contains(commodities[random]));
        System.out.println(stackCommmodities.remove(commodities[random]));
        System.out.println(Collections.max(stackCommmodities));
        
        System.out.println(queueCommmodities.contains(commodities[random]));
        System.out.println(queueCommmodities.remove(commodities[random]));
        System.out.println(Collections.max(queueCommmodities));
